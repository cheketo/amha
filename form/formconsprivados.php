 ...
 */
    ...
    */   
   define('CC_FB_TO_EMAIL', 'socios@amha.org.ar');
   /**
   ...
   function printResponsePage($form_response, $preferences)
   {
      ...
      {      
         $results_msg = 'Gracias. El formulario ha sifdo enviado.

--------------------------------------------------------
Encargada administrativa del área socios:
Sra. Graciela Méndez
4826-5852,  interno 32
